  ...
  return (
    <section className="relative pt-12 md:pt-24 pb-24 px-6 md:px-12 lg:px-20 max-w-7xl mx-auto overflow-visible bg-transparent">
      ...
      <AnimatedSection direction="up" className="mb-16 relative z-10">
        ...
        <h2 className="text-4xl md:text-5xl font-black font-headline text-white tracking-tight">Customer Reviews</h2>
      </AnimatedSection>
      ...
      <div className="flex flex-col md:flex-row gap-12 lg:gap-24 items-center md:items-start relative">
        ...
        <div className="relative w-full md:w-[35%] h-[300px] flex-shrink-0">
          ...
          <div className="absolute left-[31px] top-0 bottom-0 w-[2px] z-0 pointer-events-none overflow-visible bg-gradient-to-b from-transparent via-white/20 to-transparent"></div>
                ...
                return (
                  ...
                  >
                    <div className="w-16 flex justify-center flex-shrink-0">
                      <div 
                        ...
                        style={{ 
                          ...
                          boxShadow: isActive ? `0 0 20px ${item.color}60` : 'none',
                          color: 'white'
                        }}
                      >
                        {item.initial}
                    ...
                    <div className="flex flex-col transition-all duration-500">
                      <h4 className={`font-bold font-headline transition-colors ${isActive ? 'text-white text-lg' : 'text-gray-400 text-base'}`}>{item.name}</h4>
                    </div>
                  </motion.div>
                );
              })}
        ...
        <div className="w-full md:w-[65%] relative min-h-[250px] md:min-h-[350px] flex items-start">
          ...
          <div className="absolute top-0 left-0 text-white/5 font-serif leading-none pointer-events-none select-none" style={{ fontSize: '240px', transform: 'translateY(-60px) translateX(-30px)' }}>“</div>
          ...
          <div className="relative z-10 w-full pt-12 md:pt-[100px]">
            <AnimatePresence mode="wait">
              ...
              >
                <p className="text-2xl md:text-3xl lg:text-[2rem] text-white font-serif leading-[1.4] italic tracking-wide">
                  {activeReview.text}
                </p>
              </motion.div>
            </AnimatePresence>
