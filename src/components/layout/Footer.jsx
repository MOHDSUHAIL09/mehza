...
const Footer = () => {
  ...
  return (
    <footer className="bg-[#0A0F1C] w-full relative overflow-hidden">
      ...
      <div className="max-w-full mx-auto px-4 md:px-8 pt-16 pb-5">

        {/* Main Footer Grid - Mobile: 2 columns, Desktop: 12 columns */}
       <div className="grid px-2 lg:px-16 grid-cols-2 lg:grid-cols-12 gap-6 lg:gap-6 mb-16">
          
          {/* Brand Column - Mobile: full width, Desktop: 3 columns */}
            ...
            <div className="flex gap-3 mt-2">
              {[
                ...
                <motion.a
                  ...
                  whileTap={{ scale: 0.95 }}
                  className="w-9 h-9 rounded-full bg-white/5 border border-white/10 flex items-center justify-center text-gray-400 transition-all duration-300 group/social"
                  style={{
                    '--hover-color': social.hoverColor
                  }}
                >
                  <svg className="w-4 h-4 fill-current transition-colors duration-300 group-hover/social:text-[var(--hover-color)]" viewBox="0 0 24 24">
                    <path d={social.icon} />
                  </svg>
                </motion.a>
              ))}
          ...
          {/* Company - Mobile: 1 column, Desktop: 2 columns */}
          ...
          {/* Solutions - Mobile: 1 column, Desktop: 2 columns */}
          <div className="lg:col-span-2">
            <div className="flex flex-col gap-4">
          ...
          {/* Support - Mobile: 1 column, Desktop: 2 columns */}
          <div className="lg:col-span-2">
            <div className="flex flex-col gap-4">
          ...
          {/* Address - Mobile: 1 column, Desktop: 3 columns */}
          <div className="lg:col-span-3">
            <div className="flex flex-col gap-4">
              <h3 className="text-white text-sm font-semibold tracking-wider">ADDRESS</h3>
              <ul className="flex flex-col gap-3">
                <li className="flex gap-2.5 items-start">
                  <MdLocationOn className="text-[#00C6FF] text-base flex-shrink-0 mt-0.5" />
                  <span className="text-gray-400 text-xs leading-relaxed">
                    Office No 325, Block A, 1st Floor, Thum Height Plot No A-16, Industrial Area Noida Sector 62, UP 201309
                  </span>
                </li>
                <li className="flex gap-2.5 items-center">
                  <MdEmail className="text-[#00C6FF] text-base flex-shrink-0" />
                  <a href="mailto:Info@mehzasmarttech.com" className="text-gray-400 hover:text-[#00C6FF] text-xs transition-colors duration-300 break-all">
                    Info@mehzasmarttech.com
                  </a>
                </li>
                <li className="flex gap-2.5 items-center">
                  <MdPhone className="text-[#00C6FF] text-base flex-shrink-0" />
                  <a href="tel:+918796464606" className="text-gray-400 hover:text-[#00C6FF] text-xs transition-colors duration-300">+91 8796464606</a>
                </li>
                <li className="flex gap-2.5 items-center">
                  <MdPhone className="text-[#00C6FF] text-base flex-shrink-0" />
                  <a href="tel:+9112069069671" className="text-gray-400 hover:text-[#00C6FF] text-xs transition-colors duration-300">+91 12069069671</a>
                </li>
              </ul>
            </div>
          </div>
        ...
        <div className="pt-8 border-t border-white/10 flex flex-col md:flex-row justify-between items-center gap-4 text-center">
          ...
          <div className="flex gap-6">
            <Link to="/privacy-policy" className="text-gray-500 hover:text-blue-400 text-xs transition-colors duration-300">Privacy Policy</Link>
            <Link to="/terms-and-conditions" className="text-gray-500 hover:text-blue-400 text-xs transition-colors duration-300">Terms & Conditions</Link>
            <Link to="/compliance" className="text-gray-500 hover:text-blue-400 text-xs transition-colors duration-300">Compliance</Link>
          </div>
        </div>
      </div>
    </footer>
