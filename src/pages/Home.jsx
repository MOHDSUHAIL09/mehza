...
const Home = () => {
  ...
  const productsList = [
    ...
    { id: 1, name: "Sanitary Pad Vending Machine", icon: <BsFillDpadFill size={45} /> },
    ...
    { id: 5, name: "Microsoft Teams Rooms", icon: <MdOutlineGroups size={45} /> },
  ];
  ...
  `}</style>
      ...
      <div className="w-full relative overflow-hidden ">
        ...
        <section className="relative min-h-screen md:min-h-[100svh] flex items-center justify-center pt-24 md:pt-[1vh] z-10 px-4 md:px-8">
          <div className=""></div>
    ...
    <span>4K Ultra HD display with full channel 4K UI display</span>
  </div> */}
                <div className="flex items-start gap-2 text-sm text-slate-600 dark:text-gray-400">
                  <span className="text-[#00C6FF] mt-0.5">✓</span>
